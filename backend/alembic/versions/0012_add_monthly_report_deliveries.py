...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint(
            "user_id", "report_month", name="uq_monthly_report_deliveries_user_month"
        ),
    )
    op.create_index(
        "ix_monthly_report_deliveries_user_id", "monthly_report_deliveries", ["user_id"]
    )
    op.create_index(
        "ix_monthly_report_deliveries_report_month", "monthly_report_deliveries", ["report_month"]
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_monthly_report_deliveries_report_month", table_name="monthly_report_deliveries"
    )
