...
class Expense(Base):
    ...
    transaction_type: Mapped[str] = mapped_column(
        String(20), nullable=False, server_default="debit", index=True
    )
    ...
    cadence: Mapped[str] = mapped_column(
        String(20), nullable=False, server_default="one_time", index=True
    )
    ...
    recurring_variable: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=False, server_default="false"
    )
    recurring_auto_add: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=False, server_default="false"
    )
    recurring_source_expense_id: Mapped[uuid.UUID | None] = mapped_column(
        Uuid(as_uuid=True),
